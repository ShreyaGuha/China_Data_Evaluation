...
filepath_dir <- "C:/Users/15712/Desktop/China_obs/Haotian/home/jyq/aqdata"
...
reader.fn <- function( file_in ){
  ...
  dat_in[, day_hr := formatC( day_hr, width = 4, flag = '0')]
  dat_in[, `:=`( day = substr( day_hr, 1, 2),
                 hr = substr( day_hr, 3, 4))]
...
# test with the first 10 files
# rbind the list
in_data_daily <- 
  mclapply( files_no_2012[1:122604],
            reader.fn) %>% rbindlist()

#files_no_2012[122584]