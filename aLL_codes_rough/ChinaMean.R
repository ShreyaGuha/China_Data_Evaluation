...
setwd("C:/Users/15712/Desktop/China_obs/??????_20140513-20141231")

#list the files
data_files <- list.files("C:/Users/15712/Desktop/China_obs/??????_20140513-20141231")
...
# add a year column
PM_2017_mean[, year := 2014]


#save datasets
write.csv(PM_2017, file = "PM_2014_hourly.csv", row.names = F)
fwrite(PM_2017_mean, file = "PM_2014_annual_mean.csv", row.names = F)
